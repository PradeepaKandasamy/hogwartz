...
const ContactInfo = ({ isDark }) => {
    const contactMethods = [
        {
            ...
            value: "hogwartzdigitalworks@gmail.com",
            sub: isDark ? "Sent via Owl Post" : "Direct Inbox",
            link: "mailto:hogwartzdigitalworks@gmail.com"
        },
        {
            icon: <Phone className="w-6 h-6" />,
            title: isDark ? "Phone Call" : "Phone Call",
            value: "+91 63809 88568",
            sub: "Mon - Fri, 9am - 6pm",
            link: "tel:+916380988568"
        },
        {
            icon: <MapPin className="w-6 h-6" />,
            title: isDark ? "Location" : "Location",
    ...
    const quickActions = [
        { icon: <MessageCircle className="w-5 h-5" />, label: "WhatsApp", link: "https://wa.me/916380988568", color: "hover:text-green-500" },
        { icon: <PhoneCall className="w-5 h-5" />, label: "Call Us", link: "tel:+916380988568", color: "hover:text-blue-500" },
        { icon: <Instagram className="w-5 h-5" />, label: "Insta", link: "https://instagram.com/hogwartz._.digital", color: "hover:text-pink-500" },
        ...
        >
            ...
            <div>
                ...
                <div className="flex gap-4">
                    {[
                        { icon: <Instagram className="w-5 h-5" />, link: "https://instagram.com/hogwartz._.digital", color: "hover:bg-pink-500" },
